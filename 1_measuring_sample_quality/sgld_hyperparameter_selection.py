...
class SGLD:
    ...
    def update(self, init_sample, batch_size, epsilon, n_iter, burn_in=0):
        ...
        noise_dist = torch.distributions.MultivariateNormal(
            torch.zeros(D), epsilon * torch.eye(D)
        )
...
if __name__ == "__main__":
    ...
    for epsilon in epsilon_list:
        ...
        init_sample = torch.distributions.MultivariateNormal(
        ...
        Stoch_KSD_list001.append(
            KSD.stoch_ksd(samples_red, make_score_p, int(0.01 * R), R)
        )
